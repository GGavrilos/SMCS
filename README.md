...
- The folder "Covid19_CaseStudy", containing the R-function "covid_function.R" and the R-file "main_file.R". These were used for the case study in Subection 5.1 of the preprint. More information and references about the dataset used in this case study can be found both in the preprint, as well as in the original GitHub repository by [Cramer et al.](https://zenodo.org/badge/DOI/10.5281/zenodo.6301718.svg)
